  ...
  return (
    <>
        <div className="bgimage">
            <img className='background' src={bgimage} alt="image"/>
        </div>
        ...
        <div className="photo-section" style={{ backgroundImage: "url(/bulk.jpg)" }}>
        ...
        <div className='follow-us' >
            <div className='bgimage_container col-xl-8 col-lg-8 offset-xl-2 offset-lg-2'>
              <img className='background' src={followus_bg} alt="image"/>
